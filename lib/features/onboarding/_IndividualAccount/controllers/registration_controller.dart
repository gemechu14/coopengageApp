  ...
  Future<bool> handleBasicInfoStep({
    ...
    try {
      ...
      if (serviceResult.isSuccess) {
        // Store the userId if it's returned (new user created)
        if (serviceResult.hasUserId) {
  ...
  Future<bool> handleSignatureStep({
    ...
    try {
      ...
      if (motherName == null || motherName.trim().isEmpty) {
        _formValidationNotifier.setError('motherName', 'Mother name is required');
        return false;
      }
  ...
  Future<bool> handleTermsConditionsStep({
    ...
    try {
      ...
      if (termsAccepted != true) {
        _formValidationNotifier.setError('termsAccepted', 'You must accept the terms and conditions to continue');
        return false;
      }
      ...
      _formValidationNotifier.setError('submission', 'An unexpected error occurred: $e');
      return false;
    }
  }
