  ...
  void _filterAccountTypes(String bankingType) {
    ...
    setState(() {
      ...
      filteredAccountTypes = accountTypes.where((accountType) {
        // Check banking type
        if (accountType['category'] != "DEMAND") {
          print(
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                if (result != null && result.files.single.bytes != null) {
                  ...
                  print("PDF picked from file picker.");
                }
              },
            ),
            ListTile(
              ...
              onTap: () async {
                ...
                if (image != null) {
                  ...
                  setState(() {
                    licenseFileBytes = fileBytes;
                  });
                  print("Camera image picked.");
                }
              },
            ),
            ListTile(
  ...
  registerAllUsers() async {
    ...
    for (int i = 0; i < int.parse(NumberOfMembers!); i++) {
      ...
      Map<String, dynamic> customer = {
        ...
        "phone": phoneControllers[i].text.isNotEmpty
            ? '0${phoneControllers[i].text}'
            : "",
...
// // Check if accountTypeDetails is not null and then get the id
    ...
    Map<String, dynamic> requestData = {
      ...
      // "phoneNumber": 0+ phoneNumberController.text.toString(),
