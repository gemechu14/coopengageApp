...
// // import 'package:coopengageplus/NetworkHandler.dart';
// // import 'package:coopengageplus/common_widgets/chart/AchievementBarChart.dart';
// // import 'package:coopengageplus/common_widgets/graph/line_chart_widget.dart';
// // import 'package:coopengageplus/common_widgets/text/custom_nav_heading.dart';
// // import 'package:coopengageplus/features/onboarding/pages/userListView.dart';
// // import 'package:coopengageplus/helper/databaseHelper.dart';
// // import 'package:coopengageplus/main.dart';
...
//               if (!isOnline) const SizedBox(height: 1),
//               if (!isOnline)
//                 CarouselSlider(
...
//           var currentMonthData = data['currentMonth'];
...
import 'package:flutter_secure_storage/flutter_secure_storage.dart';
import 'package:jwt_decoder/jwt_decoder.dart';
// import 'package:onboarding/Constant/SliderImage.dart';
// import 'package:onboarding/NetworkHandler.dart';
// import 'package:onboarding/common_widgets/chart/AchievementBarChart.dart';
// import 'package:onboarding/common_widgets/graph/line_chart_widget.dart';
// import 'package:onboarding/common_widgets/text/custom_nav_heading.dart';
// import 'package:onboarding/features/onboarding/pages/userListView.dart';
// import 'package:onboarding/helper/databaseHelper.dart';
// import 'package:onboarding/main.dart';
// import 'package:onboarding/service/GlobalData.dart';
// import 'package:onboarding/service/UserService.dart';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 20),
              if (isOnline || !isOnline && currentMonthData == null)
                AnimatedSmoothIndicator(
                  activeIndex: currentItem,
                  count: SliderImages.items.length,
                  effect: const WormEffect(
              ...
              // AnalyticsSection(),
              if (isOnline && currentMonthData != null)
                Container(
                    height: 250,
                    child: Padding(
                      padding: const EdgeInsets.only(left: 15, right: 15),
