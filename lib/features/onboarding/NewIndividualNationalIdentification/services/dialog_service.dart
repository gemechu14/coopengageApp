...
class DialogService {
  ...
  /// Shows a WebSocket test result dialog
  static Future<void> showWebSocketTestResultDialog({
    required BuildContext context,
    required WebSocketTestResult result,
  }) async {
    final title = result.isSuccess ? 'WebSocket Test Successful!' : 'WebSocket Test Failed!';
    final message = 'URL: ${result.url}\nMessage: ${result.message}';
